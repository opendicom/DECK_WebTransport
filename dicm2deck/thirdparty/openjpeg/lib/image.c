...
//copy comps
    ...
    p_image_dest->comps = (opj_image_comp_t*) malloc(p_image_dest->numcomps * sizeof(opj_image_comp_t));
    for (compno = 0; compno < p_image_dest->numcomps; compno++) {
...
// copy colorspace
    ...
    if (p_image_dest->icc_profile_len) {
        p_image_dest->icc_profile_buf = (OPJ_BYTE*)malloc(p_image_dest->icc_profile_len);
        ...
        opj_image_cmptparm_t *cmptparms, OPJ_COLOR_SPACE clrspc)
{
    ...
    if (image) {
        ...
        /* allocate memory for the per-component information */
        image->comps = (opj_image_comp_t*)calloc(image->numcomps,
