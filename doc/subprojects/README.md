...
DECK is a DICOM representation of DICOM information object model (IOD) and dictionary. It can be transformed back and forth to/from DICM, XML, and JSON representations. Being a new UDP datagram Application Entity, it does not implement file format (part 10), nor DICOMweb (part 18), nor DIMSE (part 4).
