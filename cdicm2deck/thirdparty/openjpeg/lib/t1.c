...
opj_t1_t* opj_t1_create(OPJ_BOOL isEncoder)
{
    ...
    l_t1 = (opj_t1_t*) calloc(1, sizeof(opj_t1_t));
    if (!l_t1) {
        return 00;
    }
        ...
        for (bandno = 0; bandno < res->numbands; ++bandno) {
            ...
            for (precno = 0; precno < res->pw * res->ph; ++precno) {
                ...
                for (cblkno = 0; cblkno < precinct->cw * precinct->ch; ++cblkno) {
                    ...
                    job = (opj_t1_cblk_decode_processing_job_t*) calloc(1,
                                   ...
                                   OPJ_BOOL check_pterm)
{
    ...
    if (cblk->numchunks > 1 || (t1->mustuse_cblkdatabuffer &&
        ...
        if (cblk_len + OPJ_COMMON_CBLK_DATA_EXTRA > t1->cblkdatabuffersize) {
            cblkdata = (OPJ_BYTE*)realloc(t1->cblkdatabuffer,
            ...
            for (bandno = 0; bandno < res->numbands; ++bandno) {
                ...
                for (precno = 0; precno < res->pw * res->ph; ++precno) {
                    ...
                    for (cblkno = 0; cblkno < prc->cw * prc->ch; ++cblkno) {
                        ...
                        opj_t1_cblk_encode_processing_job_t* job =
                            (opj_t1_cblk_encode_processing_job_t*) calloc(1,
